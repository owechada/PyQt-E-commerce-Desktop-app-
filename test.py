...
class GroceryApp(QMainWindow):
    ...
    def __init__(self, products):
        ...
        for product in products:
            ...
            background_widget.clicked.connect(partial(self.label_clicked, product.title))
            ...
            self.label_2.setText(_translate("widget", "<h2><p>"+str(product.title)+"</p></h2>"))
            self.label_3.setText(_translate("widget", product.description))
            self.label_4.setText(_translate("widget", "<p><span style=\" font-weight:700;\">N"+str(product.price)+"</span></p>"))
    ...
    def label_clicked(self, id):
         ...
         for pdt in self.products:
          if pdt.title==id:
            ...
            popup.accepted.connect(partial(additem_to_cart, pdt))
            popup.exec()
